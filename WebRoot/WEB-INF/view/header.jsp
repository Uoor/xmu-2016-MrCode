  ...
  <body>
    ...
    <nav id="menu">
        <ul>
            ...
            <li class="menu-li-head"><a href="${ctx }/customer/toRoomManage">房间管理 <i class="fa fa-building"></i></a></li>
            ...
            <li class="menu-li-head"><a href="${ctx }/customer/toTrafficRecommend">交通指南 <i class="fa fa-send"></i></a></li>
            <li class="menu-li-head"><a href="${ctx }/customer/perfectInformation">完善信息 <i class="fa fa-user"></i></a></li>
            <li class="menu-li-head"><a href="${ctx }/customer/toAboutus">关于我们 <i class="fa fa-tag"></i></a></li>
        </ul>
    </nav>
